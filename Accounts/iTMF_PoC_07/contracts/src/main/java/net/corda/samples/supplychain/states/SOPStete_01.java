...
public class SOPStete_01 implements ContractState {
    ...
    public SOPStete_01(AnonymousParty pickUpFrom, AnonymousParty deliverTo, String cargo, AbstractParty shipper) {
