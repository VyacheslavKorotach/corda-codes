...
public class SopContract implements Contract {
    ...
    public void verify(LedgerTransaction tx) {
        ...
        if (command.getValue() instanceof SopContract.Commands.StartSop) {
            ...
            requireThat(require -> {
                ...
                require.using("Output sop must have status SOP_IN_PROGRESS", output.getStatus() == SopState.Status.SOP_IN_PROGRESS);
