...
import net.corda.samples.tictacthor.contracts.SOP01Contract;
...
// * State *
// *********
@BelongsToContract(SOP01Contract.class)
public class SOP01State implements LinearState {
    ...
    public SOP01State(UniqueIdentifier playerO, UniqueIdentifier playerX, AnonymousParty me, AnonymousParty competitor) {
        //dynamic
    ...
    public SOP01State(UniqueIdentifier playerO, UniqueIdentifier playerX,
    ...
    public SOP01State returnNewSOPAfterMove(Pair<Integer,Integer> pos, AnonymousParty me, AnonymousParty competitor){
        ...
        if(SOP01Contract.SOPUtils.isGameOver(newborad)){
            SOP01State b = new SOP01State(this.playerO,this.playerX,me,competitor,!this.isPlayerXTurn,this.linearId, newborad, Status.GAME_OVER);
            return b;
        }else{
            SOP01State b = new SOP01State(this.playerO,this.playerX,me,competitor,!this.isPlayerXTurn, this.linearId, newborad, Status.GAME_IN_PROGRESS);
            return b;
        }
    }
