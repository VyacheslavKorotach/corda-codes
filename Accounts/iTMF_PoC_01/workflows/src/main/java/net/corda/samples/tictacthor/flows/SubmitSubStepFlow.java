...
@InitiatingFlow
@StartableByRPC
public class SubmitSubStepFlow extends FlowLogic<String> {
    ...
    //public constructor
    public SubmitSubStepFlow(UniqueIdentifier sopId, String whoAmI, String whereTo, int x, int y){
        this.sopId = sopId;
        this.whoAmI = whoAmI;
    ...
    public String call() throws FlowException {
        ...
        TransactionBuilder txbuilder = new TransactionBuilder(notary)
                ...
                .addCommand(new SopContract.Commands.SubmitSubStep(),Arrays.asList(myKey,targetAcctAnonymousParty.getOwningKey()));
...
@InitiatedBy(SubmitSubStepFlow.class)
class SubmitSubStepFlowResponder extends FlowLogic<Void> {
    //private variable
    private FlowSession counterpartySession;

    //Constructor
    public SubmitSubStepFlowResponder(FlowSession counterpartySession) {
