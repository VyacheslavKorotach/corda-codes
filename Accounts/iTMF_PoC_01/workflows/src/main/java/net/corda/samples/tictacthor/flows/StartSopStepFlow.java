...
@InitiatingFlow
@StartableByRPC
public class StartSopStepFlow extends FlowLogic<UniqueIdentifier> {
    ...
    //public constructor
    public StartSopStepFlow(String whoAmI, String whereTo){
        this.whoAmI = whoAmI;
...
@InitiatedBy(StartSopStepFlow.class)
class StartSopStepFlowResponder extends FlowLogic<Void> {
    //private variable
    private FlowSession counterpartySession;

    //Constructor
    public StartSopStepFlowResponder(FlowSession counterpartySession) {
